      ...
      <div className={Style.content}>
        <div className={Style.video_div}>
          ...
          <section>
            ...
            <span>
              Building a gym website becomes a piece of cake once you work with Bronx. This neat template has everything to present your gym or fitness facility online in the best possible light. Why complicate and do things from scratch if you don’t have to? Bronx also doesn’t require coding and design knowledge; it even sorts you out with hosting and domain. This all-in-one pack is for everyone, so take action and you can have a website live VERY quickly.
            </span>
